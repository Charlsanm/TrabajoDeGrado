...
Shader "RRF/Standard/BaseShader_Standard_HDRP"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_BaseTint("BaseTint", Color) = (1,1,1,0)
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 tex2DNode33 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), 1.0f );
				...
				surfaceDescription.Albedo = out_albedo21.rgb;
				surfaceDescription.Normal = out_normal37.xyz;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = out_metal10;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = ( out_albedo21 * _Emissive ).rgb;
				surfaceDescription.Smoothness = out_gloss12;
				surfaceDescription.Occlusion = out_ao11.x;
...
/*ASEBEGIN
Version=18800
285.3333;439.3333;2560;969;685.1823;620.4767;1;True;False
...
WireConnection;48;4;25;0
WireConnection;48;6;40;0
WireConnection;48;7;24;0
WireConnection;48;8;23;0
ASEEND*/
//CHKSM=6016EF13C41AD6157C1C7BCB0C40C69FABF7BFF2