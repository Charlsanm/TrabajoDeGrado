...
Shader "RRF/Standard/ExtendedShader_Standard_HDRP"
{
	Properties
	{
		...
		[ASEEnd]_UpColourAmount("UpColourAmount", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 lerpResult124 = lerp( tex2DNode1 , float4( hsvTorgb116 , 0.0 ) , packedInput.ase_color);
				...
				float clampResult77 = clamp( ( normalWS.y + _UpColourRange ) , 0.0 , 1.0 );
				float2 texCoord82 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				surfaceDescription.Albedo = lerpResult80.rgb;
				...
				surfaceDescription.Emission = ( lerpResult62 * _Emissive ).rgb;
		...
		Pass
		{
						...
						)
			{
				...
				float4 lerpResult62 = lerp( out_albedo21 , customColouring58 , _CustomColouringAmount);
				float clampResult77 = clamp( ( normalWS.y + _UpColourRange ) , 0.0 , 1.0 );
				float2 texCoord82 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_85_0 = ( _UpColourNoiseScale * 50.0 );
				float simplePerlin3D81 = snoise( float3( texCoord82 ,  0.0 )*temp_output_85_0 );
				simplePerlin3D81 = simplePerlin3D81*0.5 + 0.5;
				float simplePerlin3D95 = snoise( float3( texCoord82 ,  0.0 )*( temp_output_85_0 * 0.5 ) );
...
/*ASEBEGIN
Version=18800
933.3334;550;1365.333;689;143.0129;488.7153;1;True;False
...
Node;AmplifyShaderEditor.SamplerNode;1;-2789.638,-685.3842;Inherit;True;Property;_Albedo;Albedo;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;128;4;25;0
WireConnection;128;6;40;0
WireConnection;128;7;24;0
WireConnection;128;8;23;0
ASEEND*/
//CHKSM=69F12DE69B888BDC3E12CB660F65C261F15C2885