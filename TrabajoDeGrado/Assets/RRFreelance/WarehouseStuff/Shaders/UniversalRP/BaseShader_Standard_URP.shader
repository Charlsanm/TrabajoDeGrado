...
Shader "RRF/Standard/BaseShader_Standard_URP"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_BaseTint("BaseTint", Color) = (0,0,0,0)
		_Albedo("Albedo", 2D) = "white" {}
		_ORM("ORM(Ao,Roughness,Metal)", 2D) = "white" {}
		[Toggle(_TOGGLEROUGHNESSTOGLOSS_ON)] _ToggleRoughnessToGloss("ToggleRoughnessToGloss", Float) = 0
		_GlossAdjust("GlossAdjust", Float) = 0
		_MetalnessAdjust("MetalnessAdjust", Float) = 0
		_AO_Power("AO_Power", Float) = 0
		_AO_IntoAlbedo("AO_IntoAlbedo", Float) = 0
		_Emissive("Emissive", Float) = 0
		_NormalMap("NormalMap", 2D) = "white" {}
		_NormalMap_Power("NormalMap_Power", Float) = 0
		[ASEEnd][Toggle(_FLIPGREEN_ON)] _FlipGreen("FlipGreen?", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _FLIPGREEN_ON
			#pragma shader_feature_local _TOGGLEROUGHNESSTOGLOSS_ON
			...
			float _NormalMap_Power;
			float _Emissive;
			float _MetalnessAdjust;
			float _GlossAdjust;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 out_ao11 = saturate( ( ( temp_cast_0 * temp_output_2_0_g1 ) + appendResult7_g1 ) );
				...
				float4 tex2DNode33 = tex2D( _NormalMap, uv_NormalMap );
				float4 break42 = tex2DNode33;
				#ifdef _FLIPGREEN_ON
				float staticSwitch44 = ( 1.0 - tex2DNode33.g );
				#else
				float staticSwitch44 = tex2DNode33.g;
				#endif
				float4 appendResult43 = (float4(break42.r , staticSwitch44 , break42.b , 0.0));
				...
				float3 Albedo = out_albedo21.rgb;
				float3 Normal = out_normal37.xyz;
				float3 Emission = ( out_albedo21 * _Emissive ).rgb;
				float3 Specular = 0.5;
				float Metallic = out_metal10;
				float Smoothness = out_gloss12;
				float Occlusion = out_ao11.x;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 temp_output_46_0 = ( _BaseTint * tex2D( _Albedo, uv_Albedo ) );
				float2 uv_ORM = IN.ase_texcoord2.xy * _ORM_ST.xy + _ORM_ST.zw;
				float4 tex2DNode2 = tex2D( _ORM, uv_ORM );
				float3 temp_cast_0 = (tex2DNode2.r).xxx;
				float temp_output_2_0_g1 = _AO_Power;
				float temp_output_3_0_g1 = ( 1.0 - temp_output_2_0_g1 );
...
/*ASEBEGIN
Version=18500
190;204;2028;1022;877.4937;653.0037;1;True;False
...
Node;AmplifyShaderEditor.SamplerNode;2;-1713.908,-444.3143;Inherit;True;Property;_ORM;ORM(Ao,Roughness,Metal);2;0;Create;False;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;6;-1711.687,-217.6164;Inherit;False;Property;_AO_Power;AO_Power;6;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;45;-1623.713,-1042.556;Inherit;False;Property;_BaseTint;BaseTint;0;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-1700.65,-770.6627;Inherit;True;Property;_Albedo;Albedo;1;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-1378.003,-651.9402;Inherit;False;Property;_AO_IntoAlbedo;AO_IntoAlbedo;7;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;25;377.4683,-94.3381;Inherit;False;10;out_metal;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;39;381.5867,-260.3188;Inherit;False;37;out_normal;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;27;420.1044,-187.3905;Inherit;False;Property;_Emissive;Emissive;8;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;23;385.5602,56.82246;Inherit;False;11;out_ao;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;24;381.606,-17.28076;Inherit;False;12;out_gloss;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;40;589.1621,-237.8124;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;36;-1024.08,237.6891;Inherit;False;Property;_NormalMap_Power;NormalMap_Power;10;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;33;-1718.748,128.6277;Inherit;True;Property;_NormalMap;NormalMap;9;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-1632.908,-126.3143;Inherit;False;Property;_MetalnessAdjust;MetalnessAdjust;5;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;3;-1311.908,-430.3143;Inherit;False;Property;_ToggleRoughnessToGloss;ToggleRoughnessToGloss;3;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.BreakToComponentsNode;42;-1416.845,134.1792;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.RangedFloatNode;14;-1120.908,-305.3143;Inherit;False;Property;_GlossAdjust;GlossAdjust;4;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
WireConnection;49;3;25;0
WireConnection;49;4;24;0
WireConnection;49;5;23;0
ASEEND*/
//CHKSM=9E960B21A89E84B6076146B7F4993539B9A730DD