...
Shader "RRF/Standard/ExtendedShader_Standard_URP"
{
	Properties
	{
		...
		_HueShiftvColMasked("HueShift(vColMasked)", Float) = 0
		...
		_CustomColouringAmount("CustomColouringAmount", Float) = 0
		_PreAdd("PreAdd", Float) = 0
		_PreSelfMultiply("PreSelfMultiply", Float) = 0
		_UpColour("UpColour", Color) = (0,0,0,0)
		_HighColour("HighColour", Color) = (0,0,0,0)
		_LowColour("LowColour", Color) = (0,0,0,0)
		_UpColourNoiseScale("UpColourNoiseScale", Float) = 0
		_UpColourNoisePower("UpColourNoisePower", Float) = 0
		_UpColourRange("UpColourRange", Float) = 0
		[ASEEnd]_UpColourAmount("UpColourAmount", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _UpColourAmount;
			float _UpColourNoisePower;
			float _UpColourNoiseScale;
			float _CustomColouringAmount;
			float _MetalnessAdjust;
			float _PreSelfMultiply;
			float _PreAdd;
			float _AO_IntoAlbedo;
			float _AO_Power;
			float _HueShiftvColMasked;
			float _UpColourRange;
			float _GlossAdjust;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 lerpResult124 = lerp( tex2DNode1 , float4( hsvTorgb116 , 0.0 ) , IN.ase_color);
				...
				float3 out_ao11 = saturate( ( ( temp_cast_2 * temp_output_2_0_g1 ) + appendResult7_g1 ) );
				...
				float clampResult77 = clamp( ( WorldNormal.y + _UpColourRange ) , 0.0 , 1.0 );
				float2 texCoord82 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_85_0 = ( _UpColourNoiseScale * 50.0 );
				float simplePerlin3D81 = snoise( float3( texCoord82 ,  0.0 )*temp_output_85_0 );
				simplePerlin3D81 = simplePerlin3D81*0.5 + 0.5;
				float simplePerlin3D95 = snoise( float3( texCoord82 ,  0.0 )*( temp_output_85_0 * 0.5 ) );
				...
				float4 break101 = tex2DNode33;
				#ifdef _FLIPGREEN_ON
				float staticSwitch102 = ( 1.0 - tex2DNode33.g );
				#else
				float staticSwitch102 = 0.0;
				#endif
				float4 appendResult103 = (float4(break101.r , staticSwitch102 , break101.b , 0.0));
				...
				float3 Emission = ( lerpResult62 * _Emissive ).rgb;
				float3 Specular = 0.5;
...
/*ASEBEGIN
Version=18500
292;268;2028;1016;895.9387;747.8547;1;True;False
...
Node;AmplifyShaderEditor.SamplerNode;1;-2789.638,-685.3842;Inherit;True;Property;_Albedo;Albedo;1;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;84;-1650.692,-1867.183;Inherit;False;Property;_UpColourNoiseScale;UpColourNoiseScale;19;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;2;-1713.908,-444.3143;Inherit;True;Property;_ORM;ORM(Ao,Roughness,Metal);3;0;Create;False;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-1697.199,-221.6921;Inherit;False;Property;_AO_Power;AO_Power;7;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;119;-2451.597,-581.6277;Inherit;False;Property;_HueShiftvColMasked;HueShift(vColMasked);2;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;69;-1438.313,-1018.939;Inherit;False;Property;_PreAdd;PreAdd;14;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;99;-1506.539,-1449.252;Inherit;False;Property;_UpColourRange;UpColourRange;21;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;71;-1162.313,-1015.939;Inherit;False;Property;_PreSelfMultiply;PreSelfMultiply;15;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;104;-2711.369,-876.1337;Inherit;False;Property;_BaseTint;BaseTint;0;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;87;-718.4337,-1750.372;Inherit;False;Property;_UpColourNoisePower;UpColourNoisePower;20;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;63;-891.4066,-1236.835;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-1378.003,-651.9402;Inherit;False;Property;_AO_IntoAlbedo;AO_IntoAlbedo;8;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;56;-686.9355,-1338.648;Inherit;False;Property;_HighColour;HighColour;17;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;55;-690.1351,-1080.146;Inherit;False;Property;_LowColour;LowColour;18;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;89;-412.7021,-1750.695;Inherit;False;Property;_UpColourAmount;UpColourAmount;22;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;61;-5.374512,-413.0155;Inherit;False;Property;_CustomColouringAmount;CustomColouringAmount;13;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;79;282.5718,-442.4784;Inherit;False;Property;_UpColour;UpColour;16;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-1632.908,-126.3143;Inherit;False;Property;_MetalnessAdjust;MetalnessAdjust;6;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;39;311.5867,-270.3188;Inherit;False;37;out_normal;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;40;589.1621,-235.8124;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;27;303.1044,-192.3905;Inherit;False;Property;_Emissive;Emissive;9;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-1120.908,-305.3143;Inherit;False;Property;_GlossAdjust;GlossAdjust;5;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;36;-1029.673,288.5242;Inherit;False;Property;_NormalMap_Power;NormalMap_Power;11;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;16;-845.9083,-408.3143;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;33;-1747.205,128.6277;Inherit;True;Property;_NormalMap;NormalMap;10;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;3;-1311.908,-430.3143;Inherit;False;Property;_ToggleRoughnessToGloss;ToggleRoughnessToGloss;4;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
WireConnection;129;2;40;0
WireConnection;129;3;25;0
WireConnection;129;4;24;0
WireConnection;129;5;23;0
ASEEND*/
//CHKSM=EF03874747718709E56BB5D29C4FC06767813990